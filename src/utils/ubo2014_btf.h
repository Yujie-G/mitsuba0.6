...
#ifndef REALBTF_UBO2014_BTF_H
#define REALBTF_UBO2014_BTF_H
    ...
    */
    Spectrum get_value_by_integer_xy(
        ...
        if (!delaunay_triangles.empty()) // if $useTriangulation is true (by default) in xml
        {
            ...
            {
                // throw std::runtime_error("[ubo2014_btf.h: get_value] cannot find triangle.\n");
                SLog(mitsuba::EDebug, "[ubo2014_btf.h: get_value] cannot find triangle for light: %f, %f, %f\n", light_x, light_y, light_z);
                goto NEAREST;
            }
            ...
            {
                // throw std::runtime_error("[ubo2014_btf.h: get_value] cannot find triangle.\n");
                SLog(mitsuba::EDebug, "[ubo2014_btf.h: get_value] cannot find triangle for view: %f, %f, %f\n", view_x, view_y, view_z);
                goto NEAREST;
            }
