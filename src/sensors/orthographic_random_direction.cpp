...
public:
    ...
    //! [fjh] here we use otherSample as wiSample
    Spectrum sampleRayDifferential(RayDifferential &ray, const Point2 &pixelSample,
        ...
        // ray.setDirection(normalize(trafo(normalize(Vector(0, 0.f, 1.f)))));

        ray.setDirection(Vector(otherSample.x, otherSample.y, sqrt(1.0f - otherSample.x*otherSample.x - otherSample.y*otherSample.y)));
        ray.mint = m_nearClip;
        ray.maxt = m_farClip;
